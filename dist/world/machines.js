...
exports.machines = exports.machineTypes = exports.machineActionTypes = void 0;
exports.machineActionTypes = [
    'makeWord',
    'makeLetter',
    'demolishWord',
    'demolishLetter',
];
exports.machineTypes = [...exports.machineActionTypes, 'makeResource'];
const letterMachines = [
    {
        name: 'Graphomotus I',
        ref: 'make-letter-1-1',
        type: 'makeLetter',
...
exports.machines = [...letterMachines, ...resourceMachines, ...wordMachines];
